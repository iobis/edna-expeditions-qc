...
occurrence <- occurrence %>%
  mutate(vsearch = str_replace(str_match(identificationRemarks, "VSEARCH.*;(.*).")[,2], "_", " ")) %>%
...
detections <- detections %>%
  ...
  select(site = higherGeography, class, family, species, vsearch, group, distance, worms, thermal, score, aphiaid) %>%
